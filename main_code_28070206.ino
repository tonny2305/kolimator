...
#define YREAD1    A2
#define YREAD2    A3
#define toleransi 100  // Diperbesar dari 50 -> 100 untuk memastikan motor bisa mencapai target

// Target nilai potensiometer untuk setiap ukuran film - DIPERBAIKI BERDASARKAN DEBUGGING
// Range potensiometer: 30-102 (posisi tertutup) -> 200-400 (posisi terbuka perkiraan)
#define TARGET_18x24_X1  150  // Dari 250 -> 150 (sesuai range potensiometer)
#define TARGET_18x24_X2  180  // Dari 250 -> 180 (sesuai range potensiometer)
#define TARGET_18x24_Y1  120  // Dari 250 -> 120 (sesuai range potensiometer)
#define TARGET_18x24_Y2  180  // Dari 250 -> 180 (sesuai range potensiometer)

#define TARGET_24x30_X1  200  // Dari 350 -> 200
#define TARGET_24x30_X2  230  // Dari 350 -> 230
#define TARGET_24x30_Y1  170  // Dari 350 -> 170
#define TARGET_24x30_Y2  230  // Dari 350 -> 230

#define TARGET_30x40_X1  250  // Dari 450 -> 250
#define TARGET_30x40_X2  280  // Dari 450 -> 280
#define TARGET_30x40_Y1  220  // Dari 450 -> 220
#define TARGET_30x40_Y2  280  // Dari 450 -> 280

#define TARGET_35x43_X1  300  // Dari 550 -> 300
#define TARGET_35x43_X2  330  // Dari 550 -> 330
#define TARGET_35x43_Y1  270  // Dari 550 -> 270
#define TARGET_35x43_Y2  330  // Dari 550 -> 330

// Target untuk iluminasi (25x25 cm) - DIPERBAIKI
#define TARGET_ILUMINASI_X1  150  // Dari 250 -> 150
#define TARGET_ILUMINASI_X2  180  // Dari 250 -> 180
#define TARGET_ILUMINASI_Y1  120  // Dari 250 -> 120
#define TARGET_ILUMINASI_Y2  180  // Dari 250 -> 180

#define OPEN_X1  400  // Posisi terbuka maksimal
#define CLOSE_X1  50   // Posisi tertutup (dari 100 -> 50)
#define OPEN_X2  400
#define CLOSE_X2  100  // Sudah sesuai
#define OPEN_Y1  400
#define CLOSE_Y1  30   // Posisi tertutup (dari 100 -> 30)
#define OPEN_Y2  400
#define CLOSE_Y2  100  // Sudah sesuai
